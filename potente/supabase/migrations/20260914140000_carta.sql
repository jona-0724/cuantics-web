-- ============================================================================
--  POTENTE · la carta
--  Este archivo se llama siempre "carta": cuando la carta cambie, se copia,
--  se le pone la fecha nueva adelante y se edita lo que haya que cambiar.
--  Es re-aplicable: si se corre dos veces, deja lo mismo.
--  ---------------------------------------------------------------------------
